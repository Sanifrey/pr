...
public class Formula12Test {
	...
	@Test
	/**
	 * Тестируем методы с входными параметрами 100, 5, 6 и с предполагаемым
	 * результатом 70.0 для проверки работы программы с целыми числами. 
	...
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "5" и значением длины "6".
		 */
