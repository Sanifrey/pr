...
public class Formula9Test {
	...
	@Test
		 /** 
 * Тестируем метод с входными параметрами 100, 8, 5 и с предполагаемым результатом 60 для проверки работы программы с дробными числами.
 ...
 * Предполагается, что программа выполнит следующие расчёты: 100-8*5 и
 * вернёт значение: 60
 */
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "8" и значением длины "5".
		 */
		formula.PublicAddObject( "8", "5");
		/**
		 ...
		 * вернёт значение: 60
		 */
		assertEquals("60.0",formula.PFormula("100"));
		/**
