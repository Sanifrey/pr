...
public class Formula10Test {
	...
	@Test
		 /** 
 * Тестируем метод с входными параметрами 100, 4, 5 и с предполагаемым результатом 80 для проверки работы программы с дробными числами.
 ...
 */
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "4" и значением длины "5".
		 */
		formula.PublicAddObject( "4", "5");
		/**
