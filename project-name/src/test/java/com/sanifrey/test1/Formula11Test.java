...
public class Formula11Test {
	...
	@Test
	/**
	 * Тестируем методы с входными параметрами 100, 5, 2 и с предполагаемым
	 * результатом 90.0 для проверки работы программы с целыми числами. 
	 ...
	 * 100-5*2 и вернёт значение: 90.0.
	 */
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "5" и значением длины "2".
		 */
		 ...
		 * вернёт значение: 90.0
		 */
		assertEquals("90.0", formula.PFormula("100"));
		/**
