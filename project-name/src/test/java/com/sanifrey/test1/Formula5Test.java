...
public class Formula5Test {
	...
	@Test
	 /** 
 * Тестируем методы с входными параметрами 90, 5, 8 и с предполагаемым результатом 50.0 для проверки работы программы с целыми числами.
 ...
 */ 
	public void testFormula1() {
		/**
		 * Добавляем объект для расчётов при помощи метода PublicAddObject со значением ширины "5" и значением длины "8".
		 */
		formula.PublicAddObject("5", "8");
		/**
		 * Выполняем расчёт свободной площади с выше добавленным объектом при значении всей площади "90".
